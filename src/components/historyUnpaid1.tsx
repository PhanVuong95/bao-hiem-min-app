...
const HistoryUnpaid1Page: React.FunctionComponent = (props) => {
  return (
    <div>
      <div className="bg-[#00BA00] py-[12px] px-4 flex flex-row items-center justify-between">
        <p className="text-white text-sm font-normal">Trạng thái</p>
        <p className="text-white text-sm font-semibold">Hoàn thành</p>
      </div>
...
export default HistoryUnpaid1Page;
