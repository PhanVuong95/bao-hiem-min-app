  ...
  return (
    <div className="max-w-sm mx-auto p-4 bg-white w-full rounded-xl">
      ...
      {loading ? (
        ...
        <select
          id="countries"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-normal rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
