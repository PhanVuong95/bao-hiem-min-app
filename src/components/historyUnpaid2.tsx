...
const HistoryUnpaid2Page: React.FunctionComponent = (props) => {
  return (
    <div>
      <div className="bg-[#F00] py-[12px] px-4 flex flex-row items-center justify-between">
        <p className="text-white text-sm font-normal">Trạng thái</p>
        <p className="text-white text-sm font-semibold">Không thành công</p>
      </div>
...
export default HistoryUnpaid2Page;
