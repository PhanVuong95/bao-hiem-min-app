    ...
    <div>
      ...
      <Page className="page mt-20" >
        <div className="rounded-xl p-4 bg-white">
          ...
          <div className="mt-4">
            {ItemInfo({ image: money, "title": "Doanh thu", "value": formatMoneyVND(report?.personalTotalOrderSuccessValue), "subtitle": "Vnđ" })}
        ...
        <div className="rounded-xl p-4 bg-white mt-4">
          <div className="text-[#0076B7] font-medium text-[18px]">Báo cáo của cộng tác viên</div>
          <div className="grid mt-4 gap-y-4 gap-x-4 grid-cols-2 ">


            {ItemInfo({ image: group, "title": "Cộng tác viên", "value": formatMoneyVND(report?.totalContributors), "subtitle": "Số tài khoản" })}


            {ItemInfo({ image: wallet, "title": "Lượt mua", "value": formatMoneyVND(report?.contributorTotalOrderSuccess), "subtitle": "Đơn hàng" })}
          ...
          <div className="mt-4">
            {ItemInfo({ image: money, "title": "Doanh số", "value": formatMoneyVND(report?.contributorTotalOrderSuccessValue), "subtitle": "Vnđ" })}
          </div>
